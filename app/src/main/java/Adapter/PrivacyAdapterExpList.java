...
public class PrivacyAdapterExpList extends BaseExpandableListAdapter {
    private Context ctx;
    private HashMap<String, List<String>> childDataList;
    private List<String> aboutUsList;

    public PrivacyAdapterExpList(Context ctx, HashMap<String, List<String>> childDataList, List<String> aboutUsList) {
        this.ctx = ctx;
